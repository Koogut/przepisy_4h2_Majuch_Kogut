...
CREATE TABLE `dania_skladnik_uzytkownikow` (
  ...
  `id_danie_uzytk` int(11) NOT NULL,
  `id_skladnik` int(11) NOT NULL,
  `ilosc` decimal(8,2) NOT NULL,
  `jednostka` varchar(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(7, 'admin67', 'email@e', '$2y$10$FiSrXOyLQvb.KwPbrQTkceHUGyMWCoevxhGvmDVlqbQrXUdyfFB2a');
...
ALTER TABLE `dania_skladnik_uzytkownikow`
  ...
  ADD KEY `id_danie_uzytk` (`id_danie_uzytk`,`id_skladnik`),
  ADD KEY `id_skladnik` (`id_skladnik`);
...
--
-- Constraints for table `dania_skladnik_nasze`
--
ALTER TABLE `dania_skladnik_nasze`
  ADD CONSTRAINT `dania_skladnik_nasze_ibfk_1` FOREIGN KEY (`id_skladnik`) REFERENCES `skladniki` (`ID_skladnik`) ON DELETE CASCADE,
  ADD CONSTRAINT `dania_skladnik_nasze_ibfk_2` FOREIGN KEY (`id_danie`) REFERENCES `dania_nasze` (`ID_danie`) ON DELETE CASCADE;

--
-- Constraints for table `dania_skladnik_uzytkownikow`
--
ALTER TABLE `dania_skladnik_uzytkownikow`
  ADD CONSTRAINT `dania_skladnik_uzytkownikow_ibfk_1` FOREIGN KEY (`id_danie_uzytk`) REFERENCES `dania_uzytkownikow` (`ID_danie_uzykownikow`),
  ADD CONSTRAINT `dania_skladnik_uzytkownikow_ibfk_2` FOREIGN KEY (`id_skladnik`) REFERENCES `skladniki` (`ID_skladnik`);
...
ALTER TABLE `ulubione_danie`
  ...
  ADD CONSTRAINT `ulubione_danie_ibfk_2` FOREIGN KEY (`ID_danie`) REFERENCES `dania_nasze` (`ID_danie`) ON DELETE CASCADE;
COMMIT;
