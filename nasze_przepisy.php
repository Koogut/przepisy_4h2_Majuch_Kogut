...
<?php if($prevRes): ?>
<a href="nasze_przepisy.php?id=<?php echo $prevRes['ID_danie']; ?>">⬅ Poprzedni</a>
<?php endif; ?>

| <a href="startowa.php">Powrót</a> |

<?php if($nextRes): ?>
<a href="nasze_przepisy.php?id=<?php echo $nextRes['ID_danie']; ?>">Następny ➡</a>
<?php endif; ?>
